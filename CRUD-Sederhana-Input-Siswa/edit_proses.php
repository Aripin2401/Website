<?php
		...
		$upgrade = mysqli_query($koneksi, "UPDATE siswa SET nik_siswa='$nik_siswa', nama_siswa='$nama_siswa', kelas_siswa='$kelas_siswa', jurusan_siswa='$jurusan_siswa', alamat_siswa='$alamat_siswa', nomor_hp_siswa='$nomor_hp_siswa' WHERE id_siswa='$id_siswa'");//data yang akan di simpan setelah di ubah
		if ($upgrade) {
