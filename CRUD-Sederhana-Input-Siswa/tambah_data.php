...
$insert = mysqli_query($koneksi, "INSERT INTO siswa VALUES(NULL, '$nis_siswa', '$nama_siswa', '$kelas_siswa', '$jurusan_siswa', '$alamat_siswa', '$nomor_hp_siswa')") or die(mysqli_error()); //kode untuk memasukkan data ke phpmyadmin dari halaman tambah.php

if ($insert) {
	echo "Data bernama ".$nama_siswa." Berhasil Ditambahkan";
	echo "<a href=index.php>Kembali</a>"; //keterangan data berhasil disimpan dalam database
}else {
