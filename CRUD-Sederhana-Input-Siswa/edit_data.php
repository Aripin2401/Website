...
<body>
	...
	<table>
		...
		$ambil = mysqli_query($koneksi, "SELECT * FROM siswa WHERE id_siswa='$id_siswa'"); //mengambil data yang tersimpan di database

		if (mysqli_num_rows($ambil)==0) {
			echo "Data kosong belum berubah";
		} else {
			$data = mysqli_fetch_assoc($ambil);//menampilkan setiap data yang akan berubah, tidak perlu siswa_id karena id primary-key tidak bisa diubah
		}
		?>
